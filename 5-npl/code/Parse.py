        ...
        if result:
            ...
            for x in output:
                ...
                for statements in x[1:-1].split('] ['):
                    ...
                    res.append(stat)
                    # print replaceValues(represent.split(), result)
                # print replaceValues(x[1:-1].split(" "), result)
            print res
            return res
    return False
